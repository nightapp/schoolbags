...
<?php
	...
	$sql="SELECT * from classlist,classlistofusers,subjects WHERE subjects.ID=classlist.subjectID AND classlist.classID=classlistofusers.classID AND classlist.schoolID='".$_SESSION["schoolID"]."' AND studentID='".$dispAs."'";
